...
- ## Acte 3 (hacking / running)
	- quand on arrive au **-3**, on rencontre nobody direct
	-
	- #### cinématique 3 (mandatory)
		- nobody se ramène et nous dit "hey bob what's up ? you get out of your cave ?"
		- bob : "yep i don't have any pastas anymore i need to get some ! it's pasta day"
		- nobody : "... okeeey"
		- bob : "do you have any ?"
		- nobody : "nope, good luck going up to the store aha, it blew up yesterday, u gotta go to the surface Lidl" (mdrr elle se moque de nous)
		- bob devient fou, prend feu, puis se calme et dit : "ok no problem" *- perso.rage*
		- nobody : "come take a thé !"
		- bob : "okey !"
		- bob suit nobody jusqu'à chez elle, là elle roule une clope  *- nobody.roll_cig*
		...
		- nobody s'étouffe dans son thé *- nobody.drink - nobody.choke_drinking* puis elle se marre et nous dit : "let's see this", ensuite elle prend son ordi, nous fait une sauvegarde puis appelle tous ses drones qui nous attaquent.
		-
	- #### gameplay combat nobody 1
		- les drones nous attaquent, nobody aussi si on en tue un / si on l'attaque
		- les portes sont lock, aucun moyen de sortir sauf de tuer nobody et de choper son ordi
	...
	-
	- #### cinématique 4 (optionnelle)
		- on se réveille attaché à une chaise et nobody qui nous electrochoc. un ordi est posé sur la table pas loin, avec notre katana. on a les shoes par contre
		- nobody : "ahh finally ! here is the *best runner in the world test* for you !
		- bob : "did i just died ?"
		- nobody : "first time uh ? i cloned you, nothing special i mean do you live in a cave ? ahahah funny"
		- bob : "eum ok i don't care could you please release me ?"
		- nobody : "nope, you figure it out yourself !" et là elle active des lasers qui enferment bob sur sa chaise et la table avec l'ordi.
		- nobody : "if you escape, you can keep the laptop !" puis elle se barre de la pièce, juste avant de fermer la porte à clé
	-
