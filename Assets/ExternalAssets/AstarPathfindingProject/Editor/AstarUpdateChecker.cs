...
namespace Pathfinding {
	...
	public static class AstarUpdateChecker {
		...
		static void DownloadVersionInfo () {
			var script = AstarPath.active != null ? AstarPath.active : GameObject.FindObjectsByType<AstarPath>(FindObjectsSortMode.None).FirstOrDefault() as AstarPath;
			...
			bool mecanim = GameObject.FindObjectsByType<Animator>(FindObjectsSortMode.None).FirstOrDefault() != null;
