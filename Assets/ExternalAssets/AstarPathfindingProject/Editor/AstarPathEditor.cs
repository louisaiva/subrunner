...
namespace Pathfinding {
	...
	public class AstarPathEditor : Editor {
		...
		public static void EditTags () {
			AstarPath astar = GameObject.FindObjectsByType<AstarPath>(FindObjectsSortMode.None).FirstOrDefault();
		...
		public static void MenuScan () {
			if (AstarPath.active == null) {
				AstarPath.active = GameObject.FindObjectsByType<AstarPath>(FindObjectsSortMode.None).FirstOrDefault();
				if (AstarPath.active == null) {
					return;
				}
			}
