...
public class LevelTranslator : MonoBehaviour
{
    ...
    [Header("Doors & Lights")]
    public string vertical_door_template = "steel_door";
    public string horizontal_door_template = "steel_door_LR";
    ...
    private bool find_or_create_door(Transform capables_parent, WorldDoorVisualizer door_visu, ref List<Door> existing_doors, ref List<Capable> new_capables)
    {
        ...
        {
            // we create the door
            string template = door_visu.is_vertical ? vertical_door_template : horizontal_door_template;
