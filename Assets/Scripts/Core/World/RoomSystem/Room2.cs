...
public class Room2 : MonoBehaviour
{
    ...
    // the priority which who the Level2.cs will find the lights
    // the more close to infinity you are, the more you will be found first
    // if their is several Collider2D overlapping for the perso Room2
    ...
    public void Hide()
    {
        ...
        if (debug) { Debug.Log("(Room2) Hiding room " + gameObject.name); }
    ...
    public void Show()
    {
        if (debug) { Debug.Log("(Room2) Showing room " + gameObject.name); }
