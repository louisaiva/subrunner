...
public class CapableEngine : BSOD_System<CapableEngine>
{
    ...
    public override async Task LoadWorldData(string world_id, bool log)
    {
        ...
        await RoomEngine.DoorEngine.LoadWorldData(world_id, log);
    ...
    public void DespawnCapable(CapableData cdata, bool destroy_data = true)
    {
        ...
        // ! HERE WE DESTROY THE DATA -> means the capable is never coming back to life, we don't need the data anymore
